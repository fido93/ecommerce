...
import com.ecommerce.catalog.ContainersConfig;
...
@DataJpaTest(properties = {"spring.test.database.replace=none", "spring.datasource.url=jdbc:tc:postgresql:16-alpine:///db"})
